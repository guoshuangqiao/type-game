...
game.prototype={
	...
	getLetter:function(num){
		...
		for(var i=0;i<arr.length;i++){
			...
			span.style.cssText="width:"+width+"px;height:"+width+"px;position:absolute;left:"+x+"px;top:"+y+"px;color:black;font-size:30px;font-weight:bold;line-height:120px;text-align:center;background:url('./img/9.jpg');background-size:cover";
